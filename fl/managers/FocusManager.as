package fl.managers
{
   ...
   public class FocusManager implements IFocusManager
   {
      ...
      {
         var _loc3_:fl.controls.Button = null;
         if(!activated)
         {
            return;
         }
      ...
      public function set defaultButton(param1:fl.controls.Button) : void
      {
         var _loc2_:fl.controls.Button = !!param1 ? Button(param1) : null;
