package fl.video
{
   ...
   public class VolumeBarAccImpl extends AccessibilityImplementation
   {
      ...
      private var _vc:fl.video.FLVPlayback;
      ...
      override public function accLocation(param1:uint) : *
      {
         ...
         var _loc3_:UIManager = this._vc.flvplayback_internal::uiMgr as UIManager;
         var _loc4_:DisplayObject = _loc3_.flvplayback_internal::controls[UIManager.VOLUME_BAR] as DisplayObject;
      ...
      {
         var _loc2_:UIManager = this._vc.flvplayback_internal::uiMgr as UIManager;
         var _loc3_:Boolean = _loc2_.flvplayback_internal::_isMuted;
         var _loc4_:Number = _loc3_ ? Math.round(_loc2_.flvplayback_internal::cachedSoundLevel * 1000) / 100 : Math.round(this._vc.volume * 1000) / 100;
         if(param1 == 1)
         {
         ...
         _loc2_.flvplayback_internal::cachedSoundLevel = this._vc.volume;
         if(_loc3_)
         {
            _loc2_.flvplayback_internal::_isMuted = true;
            _loc2_.flvplayback_internal::cachedSoundLevel = this._vc.volume;
            this._vc.volume = 0;
            _loc2_.flvplayback_internal::setEnabledAndVisibleForState(UIManager.MUTE_OFF_BUTTON,VideoState.PLAYING);
            _loc2_.flvplayback_internal::skinButtonControl(_loc2_.flvplayback_internal::controls[UIManager.MUTE_OFF_BUTTON]);
            _loc2_.flvplayback_internal::setEnabledAndVisibleForState(UIManager.MUTE_ON_BUTTON,VideoState.PLAYING);
            _loc2_.flvplayback_internal::skinButtonControl(_loc2_.flvplayback_internal::controls[UIManager.MUTE_ON_BUTTON]);
         }
      }
