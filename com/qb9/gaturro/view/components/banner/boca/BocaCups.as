package com.qb9.gaturro.view.components.banner.boca
{
   ...
   public class BocaCups extends InstantiableGuiModal implements IHasOptions
   {
      ...
      public function BocaCups(param1:String = "", param2:String = "")
      {
         super("BocaCups","BocaCupsAsset");
      }
      ...
      public function set options(param1:String) : void
      {
         ...
         this.model = settings.bocaCups[this._options];
