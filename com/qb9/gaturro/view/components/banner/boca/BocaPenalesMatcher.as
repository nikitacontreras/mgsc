package com.qb9.gaturro.view.components.banner.boca
{
   ...
   public class BocaPenalesMatcher extends InstantiableGuiModal implements IHasRoomAPI
   {
      ...
      public function BocaPenalesMatcher()
      {
         super("BocaPenalesMatcher","BocaPenalesMatcher");
      }
      ...
      private function onButtonClicked(param1:MouseEvent = null) : void
      {
         ...
         api.trackEvent("BOCA:PENALES","invitacion");
         this._roomAPI.room.proposeInteraction(InteractionTypes.FUTBOL_GAME,_loc2_);
