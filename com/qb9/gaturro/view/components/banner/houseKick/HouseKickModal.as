package com.qb9.gaturro.view.components.banner.houseKick
{
   ...
   public class HouseKickModal extends InstantiableGuiModal implements IHasRoomAPI
   {
      ...
      public function HouseKickModal()
      {
         super("HouseKickBanner","HouseKickBanner");
      }
      ...
      private function onButtonClicked(param1:MouseEvent = null) : void
      {
         ...
         this._roomAPI.room.proposeInteraction(InteractionTypes.KICK_HOUSE,_loc2_);
