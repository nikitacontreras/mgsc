package com.qb9.gaturro.view.components.banner.albumXmas2018
{
   ...
   public class XmasBoosterRewardBanner extends InstantiableGuiModal implements IHasData, IHasRoomAPI
   {
      ...
      public function XmasBoosterRewardBanner(param1:String = "", param2:String = "")
      {
         super("xmasBoosterGUI","xmasBoosterGUIasset");
      }
      ...
      private function setupView(param1:Event = null) : void
      {
         ...
         this._settings = this.mundialDef.Xmas18Cards;
         ...
         api.trackEvent("FEATURES:XMAS_2018:BOOSTER:OPEN"," ");
         api.freeze();
      ...
      private function initconfig() : void
      {
         ...
         var _loc1_:String = URLUtil.getUrl("cfgs/banners/XmasCards2018.json");
