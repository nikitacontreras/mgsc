package com.qb9.gaturro.view.components.banner.albumXmas2018
{
   ...
   public class AlbumXmas2018Banner extends AbstractCanvasFrameBanner implements ISwitchPostExplanation
   {
       
      
      private var _taskRunner:TaskRunner;
      
      public function AlbumXmas2018Banner()
      {
         super("albumXmas2018","albumBannerAsset");
      }
      ...
      override protected function setupCanvas() : void
      {
         ...
         addCanvas(new AlbumXmas2018Canvas("cardViewer","cardViewer",canvasContainer,this));
