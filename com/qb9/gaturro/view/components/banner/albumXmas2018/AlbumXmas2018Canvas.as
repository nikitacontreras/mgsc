package com.qb9.gaturro.view.components.banner.albumXmas2018
{
   ...
   public class AlbumXmas2018Canvas extends FrameCanvas
   {
      ...
      private const PREMIOS:String = "xmas2018_prizes";
      
      private const PACK_PATH:String = "navidad2018/album.card";
      
      private var setupFinished:Boolean;
      
      private var taskRunner:TaskRunner;
      
      private const FIGURITAS:String = "xmas2018_figuritas";
      ...
      public function AlbumXmas2018Canvas(param1:String, param2:String, param3:DisplayObjectContainer, param4:InstantiableGuiModal)
      {
         this.cardsPlaced = [];
         this.cardsOwned = [];
         this.config = {
            ...
            "prizes":{
               "page_0":"christmas2.paloma",
               "page_1":"christmas2.mecedora",
               "page_2":"christmas2.cama",
               "page_3":"christmas.arbolito3",
               "page_4":"christmas.muniecoGaturro",
               "page_5":"christmas.muniecoNieve",
               "page_6":"christmas.muniecoNoel",
               "page_7":"navidad2015.sidecarNavidad"
            },
            "positions":{
               "banderas":{
                  "page_0":[1,3,5,7],
      ...
      private function onHelp(param1:MouseEvent) : void
      {
         ...
         AlbumXmas2018Banner(_owner).switchCanvas("help");
      }
      ...
      {
         this.taskRunner = (owner as AlbumXmas2018Banner).taskRunner;
         api.setAvatarAttribute("action","showObjectUp.navidad2018/props.albumLee");
