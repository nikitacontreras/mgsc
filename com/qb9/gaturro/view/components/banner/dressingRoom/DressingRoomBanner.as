package com.qb9.gaturro.view.components.banner.dressingRoom
{
   ...
   public class DressingRoomBanner extends AbstractCanvasFrameBanner implements IHasRoomAPI, ISwitchPostExplanation, IHasOptions
   {
      ...
      public function DressingRoomBanner()
      {
      ...
      {
         addCanvas(new DressingFastCanvas(DRESSING,DRESSING,canvasContainer,this));
      ...
      private function onCostumesLoaded(param1:Event = null) : void
      {
         ...
         setTimeout(switchTo,1200,DRESSING);
      }
