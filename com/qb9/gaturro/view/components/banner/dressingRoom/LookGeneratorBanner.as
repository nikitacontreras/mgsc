package com.qb9.gaturro.view.components.banner.dressingRoom
{
   ...
   public class LookGeneratorBanner extends AbstractCanvasFrameBanner implements IHasRoomAPI, ISwitchPostExplanation, IHasOptions
   {
      ...
      public static const DRESSING:String = "dressing";
      
      public static const LOOK:String = "lookGenerator";
      ...
      public function LookGeneratorBanner()
      {
      ...
      private function onBannersDefinitionLoaded(param1:Event = null) : void
      {
         ...
         var _loc2_:String = URLUtil.getUrl("cfgs/banners/Costumes.json");
      ...
      {
         addCanvas(new LookGeneratorCanvas(LOOK,LOOK,canvasContainer,this));
      }
