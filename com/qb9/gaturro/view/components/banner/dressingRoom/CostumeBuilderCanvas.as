package com.qb9.gaturro.view.components.banner.dressingRoom
{
   ...
   public class CostumeBuilderCanvas extends FrameCanvas
   {
      ...
      private var mouths:PartSelector;
      ...
      public function CostumeBuilderCanvas(param1:String, param2:String, param3:DisplayObjectContainer, param4:WearBuilderBanner2)
      {
         this.costumes = [];
      ...
      {
         if((_owner as WearBuilderBanner2).costumes.length > 0 || this.trySetPageCount > 5)
         {
            this.setPage();
      ...
      override protected function setupShowView() : void
      {
         ...
         this.hairs.setupButton(view,this.setPage);
         this.mouths = new PartSelector("mouths");
         this.mouths.setupButton(view,this.setPage);
         ...
         this.costumes = (owner as WearBuilderBanner2).costumes;
         var _loc1_:int = 1;
         while(_loc1_ < this.costumes.length)
         {
            if(this.costumes[_loc1_])
            {
               ...
               while(_loc3_ < _loc2_.length)
               {
                  ...
                  {
                     case this.hairs.part:
                        this.hairs.parts.push(_loc2_[_loc3_]);
                        break;
                     case this.mouths.part:
                        this.mouths.parts.push(_loc2_[_loc3_]);
                        break;
                     case this.arms.part:
      ...
      {
         return {"parts":[this.hairs.currentCostume,this.mouths.currentCostume,this.arms.currentCostume,this.legs.currentCostume,this.cloths.currentCostume,this.foot.currentCostume]};
      }
      
      private function onAccept(param1:MouseEvent) : void
      {
         WearBuilderBanner2(_owner).close();
      }
