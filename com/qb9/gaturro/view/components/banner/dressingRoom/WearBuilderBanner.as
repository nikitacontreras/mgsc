package com.qb9.gaturro.view.components.banner.dressingRoom
{
   ...
   public class WearBuilderBanner extends AbstractCanvasFrameBanner implements IHasRoomAPI, ISwitchPostExplanation, IHasOptions
   {
      ...
      public function WearBuilderBanner()
      {
      ...
      private function onBannersDefinitionLoaded(param1:Event = null) : void
      {
         ...
         var _loc2_:String = URLUtil.getUrl("cfgs/banners/CostumesGatoons.json");
      ...
      {
         addCanvas(new DressingBuildCanvas("buildingGatoons","buildingGatoons",canvasContainer,this));
      ...
      private function onCostumesLoaded(param1:Event = null) : void
      {
         ...
         setTimeout(switchTo,1200,"buildingGatoons");
      }
