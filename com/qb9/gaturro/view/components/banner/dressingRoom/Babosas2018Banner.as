package com.qb9.gaturro.view.components.banner.dressingRoom
{
   ...
   public class Babosas2018Banner extends AbstractCanvasFrameBanner implements IHasRoomAPI, ISwitchPostExplanation, IHasOptions
   {
      ...
      public static const DRESSING:String = "dressingBabosas";
      ...
      public function Babosas2018Banner()
      {
         this.dresserDefinition = [];
         this.selectedCostumes = [];
         super("DresserBabosas","DressingRoomBannerAsset");
      }
      ...
      private function onBannersDefinitionLoaded(param1:Event = null) : void
      {
         ...
         var _loc2_:String = URLUtil.getUrl("cfgs/banners/CostumesBabosas.json");
      ...
      public function get dresserType() : String
      {
         return !!this._options ? this._options : "default";
      }
      ...
      private function loadSettings() : void
      {
         ...
         LoadFileParsers.registerParser(LoadFileFormat.JSON,com.adobe.serialization.json.JSON.decode);
         var _loc1_:String = URLUtil.getUrl("cfgs/banners/DresserBanner_Babosas.json");
      ...
      {
         addCanvas(new DressingBabosasCanvas(DRESSING,DRESSING,canvasContainer,this));
      ...
      private function onCostumesLoaded(param1:Event = null) : void
      {
         ...
         setTimeout(switchTo,1200,"dressingBabosas");
      }
