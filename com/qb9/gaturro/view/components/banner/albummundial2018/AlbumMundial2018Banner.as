package com.qb9.gaturro.view.components.banner.albummundial2018
{
   ...
   public class AlbumMundial2018Banner extends AbstractCanvasFrameBanner implements ISwitchPostExplanation
   {
       
      
      private var _taskRunner:TaskRunner;
      
      public function AlbumMundial2018Banner()
      {
         super("albumMundial2018","albumBannerAsset");
      }
      ...
      override protected function setupCanvas() : void
      {
         ...
         addCanvas(new AlbumMundial2018Canvas("cardViewer","cardViewer",canvasContainer,this));
