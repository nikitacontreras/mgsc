package com.qb9.gaturro.view.components.banner.albummundial2018
{
   ...
   public class AlbumMundial2018Canvas extends FrameCanvas
   {
      ...
      private const PREMIOS:String = "mundial2018_prizes";
      
      private const PACK_PATH:String = "mundial2018/album.card";
      
      private var setupFinished:Boolean;
      
      private var taskRunner:TaskRunner;
      
      private const FIGURITAS:String = "mundial2018_figuritas";
      ...
      public function AlbumMundial2018Canvas(param1:String, param2:String, param3:DisplayObjectContainer, param4:InstantiableGuiModal)
      {
         this.cardsPlaced = [];
         this.cardsOwned = [];
         this.config = {
            "groups":[{
               "name":"GRUPO A",
               "countries":["RUSIA","ARABIA SAUDITA","EGIPTO","URUGUAY"]
            },{
               "name":"GRUPO B",
               "countries":["PORTUGAL","ESPAÑA","MARRUECOS","IRAN"]
            },{
               "name":"GRUPO C",
               "countries":["FRANCIA","AUSTRALIA","PERÚ","DINAMARCA"]
            },{
               "name":"GRUPO D",
               "countries":["ARGENTINA","ISLANDIA","CROACIA","NIGERIA"]
            },{
               "name":"GRUPO E",
               "countries":["BRASIL","SUIZA","COSTA RICA","SERBIA"]
            },{
               "name":"GRUPO F",
               "countries":["ALEMANIA","MÉXICO","SUECIA","COREA DEL SUR"]
            },{
               "name":"GRUPO G",
               "countries":["BÉLGICA","PANAMÁ","TÚNEZ","INGLATERRA"]
            },{
               "name":"GRUPO H",
               "countries":["POLONIA","SENEGAL","COLOMBIA","JAPÓN"]
            },{
               "name":"ALL-STARS",
               "countries":["ÁGATHA - GATURRO","GATEEN - GATURRIN","GATURRÓN - KATY KIT","GATULONGO - CANTURRO"]
            },{
               "name":"ESTADIO",
               "countries":["ESTADIO GATURRO","","",""]
            },{
               "name":"LA FINAL",
               "countries":["","?????","?????","?????"]
            }],
            "prizes":{
               "page_0":"mundial2018/wears.rusia2018",
               "page_1":"mundial2018/wears.portugal2018",
               "page_2":"mundial2018/wears.francia2018",
               "page_3":"mundial2018/wears.argentina2018",
               "page_4":"mundial2018/wears.brasil2018",
               "page_5":"mundial2018/wears.alemania2018",
               "page_6":"mundial2018/wears.belgica2018",
               "page_7":"mundial2018/wears.polonia2018",
               "page_8":"mundial2018/wears.allStars2018",
               "page_9":"mundial2018/deco.estadioGaturro",
               "page_10":"virtualGoods3.pelotaSaltarinaRusia"
            },
            "positions":{
               "banderas":{
                  "page_0":[1,3,5,7],
      ...
      private function givePrize(param1:int) : void
      {
         ...
         api.trackEvent("FEATURES:MUNDIAL_2018:ALBUM:RECIBE_PREMIO",this.config.prizes["page_" + param1]);
      ...
      {
         if(this.page_id == 9 || this.page_id == 10)
         {
      ...
      private function onCardClick(param1:MouseEvent) : void
      {
         ...
         api.trackEvent("FEATURES:MUNDIAL_2018:ALBUM:PEGA_CARTA",_loc4_);
         ++this.pegadasCount;
      ...
      {
         api.trackEvent("FEATURES:MUNDIAL_2018:ALBUM:HELP","true");
         AlbumMundial2018Banner(_owner).switchCanvas("help");
      }
      ...
      {
         this.taskRunner = (owner as AlbumMundial2018Banner).taskRunner;
         api.setAvatarAttribute("action","showObjectUp.mundial2018/props.albumLee");
