package com.qb9.gaturro.view.components.banner.albummundial2018
{
   ...
   public class BoosterRewardBanner extends InstantiableGuiModal implements IHasData, IHasRoomAPI
   {
      ...
      public function BoosterRewardBanner(param1:String = "", param2:String = "")
      {
         super("boosterGUI","boosterGUIAsset");
      }
      ...
      override public function dispose() : void
      {
         ...
         api.trackEvent("FEATURES:MUNDIAL_2018:BOOSTER:GIVED_CARDS:" + this._selectedCards[0].asset,"");
         api.trackEvent("FEATURES:MUNDIAL_2018:BOOSTER:GIVED_CARDS:" + this._selectedCards[1].asset,"");
         if(api.isCitizen)
         {
            api.trackEvent("FEATURES:MUNDIAL_2018:BOOSTER:GIVED_CARDS:" + this._selectedCards[2].asset,"");
         }
         api.unfreeze();
         super.dispose();
      }
      ...
      private function setupView(param1:Event = null) : void
      {
         ...
         api.trackEvent("FEATURES:MUNDIAL_2018:BOOSTER:OPEN"," ");
         api.freeze();
      ...
      private function initconfig() : void
      {
         ...
         var _loc1_:String = URLUtil.getUrl("cfgs/banners/MundialCards.json");
