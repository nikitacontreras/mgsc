package com.qb9.gaturro.view.components.banner.vestiteComoYo
{
   ...
   public class VestiteComoYo extends InteractionGuiModal
   {
      ...
      public function VestiteComoYo(param1:GaturroRoom, param2:String, param3:Function, param4:String)
      {
      ...
      override public function executeOperation(param1:String, param2:Avatar, param3:Avatar, param4:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case "dressLikeMe":
               if(!_loc5_)
               {
                  _loc6_ = (api.view.getActions() as NetActionManager).getUserCostume(avatarDataMate);
                  this._avatarDresser.dressUser(api.JSONDecode(_loc6_));
                  this.close();
                  break;
               }
               break;
      ...
      {
         var _loc1_:Object = api.getProfileAttribute("influencerPuntos");
         if(_loc1_ == null)
         {
            _loc1_ = 0;
         }
         _loc1_ += 1;
         api.setProfileAttribute("influencerPuntos",_loc1_);
