package com.qb9.gaturro.view.components.banner.noria
{
   ...
   public class NoriaMatcher extends InstantiableGuiModal implements IHasRoomAPI
   {
      ...
      private const FEAT_ATTR:String = "noria";
      ...
      public function NoriaMatcher()
      {
         super("noriaMatcher","NoriaMatcherAsset");
      }
      ...
      private function setupSelection() : void
      {
         ...
         this.confirmAccompButton = view.getChildByName("confirmAccomp") as MovieClip;
      ...
      private function takeUserToRoom() : void
      {
         ...
         setTimeout(this._roomAPI.changeRoomXY,2000,51688668,_loc1_,_loc2_);
      ...
      private function gaturroMatches(param1:String) : Boolean
      {
         ...
         if(this.selectedAvatar.attributes && this.selectedAvatar.attributes[this.FEAT_ATTR] && this.selectedAvatar.attributes[this.FEAT_ATTR] == this._roomAPI.userAvatar.username)
         {
            return true;
         }
         return false;
      ...
      {
         this._roomAPI.setAvatarAttribute(this.FEAT_ATTR," ");
      }
      ...
      private function onAvatarClick(param1:Avatar, param2:Boolean) : void
      {
         ...
         this._roomAPI.setAvatarAttribute(this.FEAT_ATTR,param1.username);
      ...
      {
         this._asset.gotoAndStop("tutorial");
         this._asset.addEventListener(Event.EXIT_FRAME,this.setupTutorial);
      }
      ...
      private function setupTutorial(param1:Event) : void
      {
         if(this._asset.hasEventListener(Event.EXIT_FRAME))
         {
            this._asset.removeEventListener(Event.EXIT_FRAME,this.setupTutorial);
         }
         this.avatarDataArray = [];
