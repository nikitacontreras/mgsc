package com.qb9.gaturro.view.components.banner.albumMonster2019
{
   ...
   public class MonsterBoosterRewardBanner extends InstantiableGuiModal implements IHasData, IHasRoomAPI
   {
      ...
      public function MonsterBoosterRewardBanner(param1:String = "", param2:String = "")
      {
         super("monsterBooster","monsterBooster");
      }
      ...
      private function initconfig() : void
      {
         ...
         var _loc1_:String = URLUtil.getUrl("cfgs/banners/Monster2019Cards.json");
