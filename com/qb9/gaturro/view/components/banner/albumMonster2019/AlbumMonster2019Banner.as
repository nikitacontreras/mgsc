package com.qb9.gaturro.view.components.banner.albumMonster2019
{
   ...
   public class AlbumMonster2019Banner extends AbstractCanvasFrameBanner implements ISwitchPostExplanation
   {
       
      
      private var _taskRunner:TaskRunner;
      
      public function AlbumMonster2019Banner()
      {
         super("albumMonster2019","albumBannerAsset");
      }
      ...
      override protected function setupCanvas() : void
      {
         ...
         addCanvas(new AlbumMonster2019Canvas("cardViewer","cardViewer",canvasContainer,this));
