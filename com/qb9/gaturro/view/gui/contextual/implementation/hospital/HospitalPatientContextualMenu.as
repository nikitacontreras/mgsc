package com.qb9.gaturro.view.gui.contextual.implementation.hospital
{
   ...
   public class HospitalPatientContextualMenu extends HospitalBaseContextualMenu
   {
       
      
      public function HospitalPatientContextualMenu(param1:ContextualMenuDefinition, param2:DisplayObject)
      {
         super(param1,param2);
      }
      ...
      override protected function notifyManger(param1:HospitalContextualMenuItemRenderer) : void
      {
         ...
         hospitalManager.propose(_loc3_);
      }
   }
}
