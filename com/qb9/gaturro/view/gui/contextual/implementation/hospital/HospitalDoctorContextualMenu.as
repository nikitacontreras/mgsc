package com.qb9.gaturro.view.gui.contextual.implementation.hospital
{
   ...
   public class HospitalDoctorContextualMenu extends HospitalBaseContextualMenu
   {
       
      
      public function HospitalDoctorContextualMenu(param1:ContextualMenuDefinition, param2:DisplayObject)
      {
         super(param1,param2);
      }
      ...
      override protected function getDataProvider() : IIterable
      {
         ...
         var _loc4_:int = hospitalManager.getProposal();
      ...
      override protected function notifyManger(param1:HospitalContextualMenuItemRenderer) : void
      {
         ...
         hospitalManager.response(_loc3_);
      }
   }
}
