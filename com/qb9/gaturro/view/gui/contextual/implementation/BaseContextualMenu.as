package com.qb9.gaturro.view.gui.contextual.implementation
{
   ...
   public class BaseContextualMenu extends AbstractContextualMenu
   {
      ...
      public function BaseContextualMenu(param1:ContextualMenuDefinition, param2:DisplayObject)
      {
         super(param1,param2);
      }
      ...
      protected function notifyManger(param1:BaseContextualMenuItemRenderer) : void
      {
         ...
         {
            this.roomViewManager.response(_loc4_);
         }
         else
         {
            this.roomViewManager.propose(_loc4_);
         }
      }
      ...
      override protected function setupButtons() : void
      {
         ...
         this.repeater.itemRendererFactory = new BaseContextualMenuItemRendererFactory(loaderWrapper,loaderWrapper.getDefinition(definition.buttonAssetClass));
      ...
      {
         var _loc2_:BaseContextualMenuItemRenderer = param1.itemRenderer as BaseContextualMenuItemRenderer;
      ...
      final protected function get roomViewManager() : AbstractProposalRoomViewManager
      {
         return AbstractProposalRoomViewManager(_data);
      }
