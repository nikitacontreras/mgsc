package com.qb9.gaturro.view.gui.contextual.implementation
{
   ...
   public class BaseContextualMenuItemRendererFactory implements IItemRendererFactory
   {
      ...
      public function BaseContextualMenuItemRendererFactory(param1:SWFLoaderWrapper, param2:Class)
      {
         super();
      ...
      public function buildItemRenderer(param1:Object) : AbstractItemRenderer
      {
         ...
         var _loc3_:AbstractItemRenderer = new BaseContextualMenuItemRenderer(this.assetClass,this.loaderWarpper);
         _loc3_.data = param1;
         return _loc3_;
      }
   }
