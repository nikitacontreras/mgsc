package com.qb9.gaturro.view.gui.base.inventory.repeater.navigation
{
   ...
   public class InventoryPageItemRendererFactory implements IItemRendererFactory
   {
       
      
      public function InventoryPageItemRendererFactory()
      {
         super();
      }
      ...
      public function buildItemRenderer(param1:Object) : AbstractItemRenderer
      {
         ...
         if(param1 is String)
         {
            if(param1.toString() == "prev")
            {
               _loc2_ = new ArrowInventoryPageItemRenderer(prevBtnItemRendererAsset);
            }
            else if(param1.toString() == "next")
            {
               _loc2_ = new ArrowInventoryPageItemRenderer(nextBtnItemRendererAsset);
            }
         }
         else if(param1 is int)
         {
            _loc2_ = new InventoryPageItemRenderer();
         }
         _loc2_.data = param1;
         return _loc2_;
      }
