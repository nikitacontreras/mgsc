package com.qb9.gaturro.view.world
{
   ...
   public class EasterMatchingRoomView extends GaturroRoomView
   {
      ...
      public function EasterMatchingRoomView(param1:GaturroRoom, param2:TaskRunner, param3:InfoReportQueue, param4:Mailer, param5:WhiteListNode)
      {
         ...
         this.bannedCostumes = ["conejoBlanco","conejoMarron","conejoPlata","conejoOro"];
