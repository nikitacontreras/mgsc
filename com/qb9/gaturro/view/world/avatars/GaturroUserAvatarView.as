package com.qb9.gaturro.view.world.avatars
{
   ...
   public final class GaturroUserAvatarView extends GaturroAvatarView
   {
       
      
      public function GaturroUserAvatarView(param1:UserAvatar, param2:TaskContainer, param3:TwoWayLink, param4:TwoWayLink)
      {
      ...
      private function tieneTransporteMagico(param1:String) : Boolean
      {
         ...
         if(param1.indexOf("invisibles/") != -1)
         {
            return true;
         }
