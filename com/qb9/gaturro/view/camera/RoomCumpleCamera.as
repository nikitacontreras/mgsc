package com.qb9.gaturro.view.camera
{
   ...
   public final class RoomCumpleCamera extends AbstractCamera implements ICamera
   {
      
      private static const roomDisplay_WIDTH:uint = 1500;
      ...
      public function RoomCumpleCamera(param1:Sprite, param2:Array, param3:int, param4:DisplayObject, param5:UserAvatar)
      {
      ...
      override protected function doMove(param1:uint) : void
      {
         ...
         else if(this.gaturro.coord.x <= 13)
         {
            this.movingTo = -310;
            this.changeDirection = true;
         }
