package com.qb9.gaturro.constraint
{
   ...
   public class TimeReachedInHoursConstraint extends AbstractConstraint
   {
      ...
      public function TimeReachedInHoursConstraint(param1:Boolean)
      {
         super(param1);
         this.setup();
      }
      ...
      override public function setData(param1:*) : void
      {
         ...
         this.interval = param1.interval * 60 * 60 * 1000;
      }
