package com.qb9.gaturro.constraint
{
   ...
   public class NpcGivesConstraint extends AbstractConstraint
   {
      ...
      public function NpcGivesConstraint(param1:Boolean)
      {
         super(param1);
         this.setup();
      }
      ...
      private function setupNotification() : void
      {
         ...
         this.notificationManager.observe(GaturroNotificationType.NPC_GIVES,this.onGives);
      }
      
      override public function setData(param1:*) : void
      {
         this.gift = param1.gift;
         this.amount = !!param1.amount ? int(param1.amount) : 1;
      }
      
      private function onGives(param1:com.qb9.gaturro.commons.manager.notificator.Notification) : void
      {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.notificationManager.unobserve(GaturroNotificationType.NPC_GIVES,this.onGives);
         }
         super.dispose();
      }
   }
