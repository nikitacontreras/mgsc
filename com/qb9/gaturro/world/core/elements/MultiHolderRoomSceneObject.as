package com.qb9.gaturro.world.core.elements
{
   ...
   public final class MultiHolderRoomSceneObject extends RoomSceneObject
   {
       
      
      private var _children:Array;
      
      public function MultiHolderRoomSceneObject(param1:CustomAttributes, param2:TileGrid)
      {
         this._children = [];
         super(param1,param2);
      }
      ...
      private function get full() : Boolean
      {
