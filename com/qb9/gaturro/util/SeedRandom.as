package com.qb9.gaturro.util
{
   ...
   public class SeedRandom
   {
      ...
      protected static var _instance:com.qb9.gaturro.util.SeedRandom;
      ...
      public function SeedRandom(param1:uint = 0)
      {
         super();
         this._seed = param1;
      ...
      public static function get instance() : com.qb9.gaturro.util.SeedRandom
      {
         if(_instance == null)
         {
            _instance = new com.qb9.gaturro.util.SeedRandom();
         }
         return _instance;
      }
